var TableDataClasses = function() {
	...
	var runDataTable_AddClasses = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[1].innerHTML = '<select><option value="1">Sumit</option><option value="2">Singh</option></select>';
		...
		$('#table-add-classes').on('click', '.cancel-row', function(e) {
			e.preventDefault();
			if (newRow) {
				newRow = false;
				actualEditingRow = null;
		...
		$('#table-add-classes').on('click', '.delete-row', function(e) {
			e.preventDefault();
		...
		$('#table-add-classes').on('click', '.save-row', function(e) {
			e.preventDefault();
		...
		$('#table-add-classes').on('click', '.edit-row', function(e) {
			e.preventDefault();
			if (actualEditingRow) {
				if (newRow) {
					oTable.fnDeleteRow(actualEditingRow);
